...
pub fn readability_rs_parse(target: &str) -> anyhow::Result<Document> {
...
pub async fn readabilipy_parse(target: &str, parser: RustpubParser, tmp_dir_path: std::path::PathBuf) -> Result<std::fs::File> {
